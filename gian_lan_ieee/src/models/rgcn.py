"""
Heterogeneous RGCN model for fraud detection.
Uses HeteroConv with GraphConv layers for relational message passing.
"""

import torch
import torch.nn as nn
import torch.nn.functional as F
from torch_geometric.nn import HeteroConv, GraphConv, BatchNorm
from torch_geometric.data import HeteroData


class HeteroRGCN(nn.Module):
    """
    Relational Graph Convolutional Network for heterogeneous fraud detection.
    
    Uses separate GraphConv weights for each relation type,
    which is the core idea behind RGCN.
    ...
    def __init__(
        ...
        # RGCN layers (GraphConv per relation)
